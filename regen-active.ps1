...
$sb.Add('<!-- GENERATED by regen-active.ps1 from per-doc frontmatter. Do not edit by hand. -->')
...
$fsb.Add('<!-- GENERATED by regen-active.ps1 from per-doc frontmatter. Do not edit by hand. -->')
$fsb.Add('# By feature')
$fsb.Add('')
